...
const BlogPage = (props: {
  ...
  session: any;
  isBookmark: boolean;
  removeFromReadingList: any;
  addToReadingList: any;
}) => {
  const {
    blogData,
    session,
        ...
        <div className="w-full text-center flex justify-center items-center">
          <div className="xl:w-[80%] lg:w-[80%] md:w-[80%] sm:w-[90%]">
            ...
            <div className="flex items-center flex-col justify-center">
              <p className="text-3xl font-extrabold py-3 ">
                {blogData[0].title}
              </p>
              ...
              {session && (
                <Image
                  ...
                  onClick={
                    isBookmark
                      ? () => removeFromReadingList(blogData[0].slug.current)
                      : () => addToReadingList(blogData[0].slug.current)
                  }
                />
              )}
            </div>
